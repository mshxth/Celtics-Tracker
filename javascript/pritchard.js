...
fetch('https://api-nba-v1.p.rapidapi.com/players/statistics?id=2635&team=2&season=2023', options)
	...
	.then(response => {
		...
		for (let i = response.response.length - 1; i > -1; i--) {
			if (response.response[i].min == null || response.response[i].points == null
				|| response.response[i].assists == null || response.response[i].totReb == null
				|| response.response[i].offReb == null || response.response[i].defReb == null
				|| response.response[i].steals == null || response.response[i].blocks == null
				|| response.response[i].turnovers == null || response.response[i].fga == null
				|| response.response[i].fgm == null || response.response[i].fgp == null
				|| response.response[i].fta == null || response.response[i].ftm == null
				|| response.response[i].ftp == null || response.response[i].tpa == null
				|| response.response[i].tpm == null || response.response[i].tpp == null
				|| response.response[i].plusMinus == null) {
		...
		function getPositions() {
			let str = response.response[1].pos;
			for (let i = 0; i < response.response.length; i++) {
				if (response.response[i].pos == null) {
          
        }
        else if (!str.includes(response.response[i].pos)) {
